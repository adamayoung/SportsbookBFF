...
public struct ImplyBetsRequest: Equatable, Hashable, Content {
    ...
    public init(betLegs: [BetLeg], scope: Scope = .all, pricePolicy: PricePolicy = .default, currency: String,
                locale: Locale) {
    ...
    public init(betLeg: BetLeg, scope: Scope = .all, pricePolicy: PricePolicy = .default, currency: String,
                locale: Locale) {
