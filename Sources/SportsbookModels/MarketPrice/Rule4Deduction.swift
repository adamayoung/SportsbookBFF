...
public struct Rule4Deduction: Equatable, Codable {

    /// Amount of the deduction.
    public let deduction: Double
    ...
    public init(deduction: Double, priceType: Rule4Deduction.PriceType, timeFrom: Date? = nil, timeTo: Date? = nil,
                selectionID: Int? = nil) {
