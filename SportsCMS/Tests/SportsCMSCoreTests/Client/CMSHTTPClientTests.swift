...
final class CMSHTTPClientTests: XCTestCase {

//    func testBaseURLWhenDevEnvironmentReturnsBaseURI() {
//        let environment = CMSEnvironment.dev
...
//    }
//
//    func testBaseURLWhenQREnvironmentReturnsBaseURI() {
//        let environment = CMSEnvironment.qr
